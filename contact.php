          ...
          <div class="col-xl-12 col-lg-12 col-md-12">
            ...
            <div class="top-bar clearfix">
              ...
              <div class="top-left-content clearfix float-left">
                ...
                <p><img src="images/Apple.png">For any business you can trust Fulton... <a href="#">Pick up.</a></p>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="inner-content clearfix">
                    <div class="header-left float-left">
                        <div class="logo">
                            <a href="index.html">
                                <img src="images/Apple-big.png" alt="Awesome Logo">
                            </a>
                        </div>
                    </div>
                    <div class="header-middle clearfix float-left">
                        ...
                        <nav class="main-menu clearfix float-left">
                                ...
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="services.php">Services</a>
                                        <ul>
                                            ...
                                            <li><a href="ser-financial.html">Financial Planning</a></li>
                                            <li><a href="ser-business.html">Business Services</a></li>
                                            <li><a href="ser-software.html">Software & Research</a></li>
                                            <li><a href="ser-quality.html">Quality Resourcing</a></li>
                                            <li><a href="ser-travel-aviation.html">Travel and Aviation</a></li>
                                            <li><a href="ser-digital.html">Digital Transformation</a></li>
                                        </ul>
                                    </li>
                            ...
                            <div class="header-right2 float-right">
                                <div class="search2">
                                      <input type="text" class="form-control input-sm" maxlength="64" placeholder="search2" />
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="button-text">
                                    <p>You have questions? Contact us today, our supportteam here to<br> help you by 24*7.</p>
                                </div>
                            </div>
                        </div>
                    </form>
                            ...
                            <div class="single-item">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="text-box">
                                            <p><span>Address:</span> 32, 2nd Breaking Stret, <br>Newyork ,USA 10002.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon-box">
                                        ...
                                        <div class="text-box">
                                            <p><span>Call Us:</span><br> +321 4567 89 012 & 79 023</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon-box">
                                        ...
                                        <div class="text-box">
                                            <p><span>Mail Us:</span> Supportteam@Brighton.com</p>
                                        </div>
                                    </li>
                                </ul>
                                <div class="bottom-info">
                                    <div class="img-holder">
                                        <img src="images/niti.png" alt="Awesome Image">
                                    </div>
                                    <div class="text-holder">
                                        <h3>Jenifer Hearly</h3>
                                        <b class="thm-clr">Manager</b>
                                        <a href="mailto:someone@example.com" target="new">
                                            <span class="icon-multimedia"></span>Jenifer@Spectrum.com
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="single-footer-widget">
                    <div class="our-info">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="images/katrori.png" alt="Awesome Logo">
                            </a>
                        </div>
                        <div class="text">
                            ...
                            <div class="bottom">
                                ...
                                <p>9am to 5pm or talk to an expert +32 4507801234 , Available 24*7.</p>  
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12">
                <div class="single-footer-widget pdtop-50">
                    ...
                    <ul class="recent-post">
                        <li>
                            <span class="thm-clr">February 26th, 2018</span>
                            <a href="#">Easy steps to move from fear to confidence.</a>
                        </li>
                        <li>
                            <span class="thm-clr">February 26th, 2018</span>
                            <a href="#">Easy steps to move from fear to confidence.</a>
...
<section class="footer-bottom-area" style="background: #0b0e2f;
    padding: 22px 0;">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="footer-bottom">
                    <div class="copyright-text pull-left">
                        <p>Copyright © 2012-2018 <a class="thm-clr" href="#">Fulton</a> Theme by <a class="thm-clr" href="#"> Themekalia</a>. All Rights Reserved.</p>
                    </div>
